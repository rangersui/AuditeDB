...
//   5. optionally runs `npm pack` to produce the publishable .tgz.
//
// Usage:
//   node scripts/pack-platform.mjs <plat> <arch> <binary-path> [--pack]
// Example:
//   node scripts/pack-platform.mjs linux x64 /tmp/elastik-core --pack
//
...
if (!plat || !arch || !src) {
    die("usage: node scripts/pack-platform.mjs <plat> <arch> <binary-path> [--pack]");
}
