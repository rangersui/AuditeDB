...
fn stamp_core_response_headers(request_id: u64, elapsed_ms: u128, headers: &mut HeaderMap) {
    headers.insert(
    ...
    headers.insert(
        HeaderName::from_static("x-elapsed-ms"),
...
mod tests {
    ...
    fn core_response_headers_are_core_owned() {
        ...
        assert_eq!(headers.get("x-elapsed-ms").unwrap(), "7");
