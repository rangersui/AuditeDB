...
__all__ = [
    ...
    "Response",
    "TimelineCoordinate", "HeadStamp", "TimelineMeta", "TimelineReadResult",
    ...
    "read_timeline", "get_timeline", "head_timeline", "chain_head",
...
def read_timeline(coordinate: TimelineCoordinate) -> TimelineReadResult:
    """elastik.read_timeline(coordinate) -> historical bytes plus proof headers."""
    return _client().read_timeline(coordinate)
...
def chain_head(path: str) -> HeadStamp | None:
    """elastik.chain_head('/home/note') -> HeadStamp or None."""
    return _client().chain_head(path)
